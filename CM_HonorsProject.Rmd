...
sppa_grades <- clmm(Grades_ordered ~ SC_lag + (1 | tagid), data = long_HonorsData, Hess=TRUE) 

## look at concurrent SPPA-SC too, report z-value & p of both

sppa_grades <- clmm(Grades_ordered ~ SC + (1 | tagid), data = long_HonorsData, Hess=TRUE) 


ctable <- coef(summary(sppa_grades))
