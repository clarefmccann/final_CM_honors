...
#Q1: Does academic acheivement change across early adolescence in girls?  

null_model_aa_age_cov<-lme(Grades ~ SES+Age_at_Menarche,
                      method="ML",
                      random = ~1|tagid,
                      data=long_HonorsData %>% 
                              filter(!is.na(Grades),
...
lin_model_aa_age_cov<-lme(Grades ~ SES+Age_at_Menarche+agecenter,
                      method="ML",
                      random = ~1|tagid,
                      data=long_HonorsData %>% 
                              filter(!is.na(Grades),
                                     ...
                                     !is.na(SES),
                                     !is.na(Age_at_Menarche)))
summary(lin_model_aa_age_cov)

quad_model_aa_age_cov<-lme(Grades ~ SES+Age_at_Menarche+agecenter+agecenter.sq,
                      method="ML",
                      random = ~1|tagid,
                      data=long_HonorsData %>% 
                             filter(!is.na(Grades),
                                     ...
                                     !is.na(SES),
                                     !is.na(Age_at_Menarche)))
summary(quad_model_aa_age_cov)

anova(null_model_aa_age_cov,quad_model_aa_age_cov, lin_model_aa_age_cov)
