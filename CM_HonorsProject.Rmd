...
var_sc_aa <- mlVAR(long_HonorsData,
                c("SC", "Grades"),
                "tagid",
                estimator="lmer",
                lags = 1,
...
lin_model_SC_CAMM_covariates<-lme(SC ~ SES+Age_at_Menarche+SC_lag+CAMM_lag+Grades,
                       method="ML",
                       random = ~1|tagid,
                       data=long_HonorsData %>% 
                         filter(!is.na(SC),
...
lin_SC_Transition_covariates<-lme(SC ~ SES+Age_at_Menarche+SC_lag+Transition+Grades,
                       method = "ML",
                       random = ~1|tagid,
                       data=long_HonorsData %>% 
                         filter(!is.na(SC),
