...
ggsave("Age_by_SC.tiff", width= 6, height=4, units= 'mm', dpi=600, bg = "transparent")
...
ggsave("CAMM_by_SC.tiff",
      plot=CAMMlag_by_SC,
      bg = "transparent",
      width= 6, height=4, units= 'mm', dpi=600)
...
ggsave("Transitions_by_SC.tiff", width= 6, height=4, units= 'mm', dpi=600, bg = "transparent")
