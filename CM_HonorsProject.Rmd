...
new <- mice(long_HonorsData, m=5, maxit = 50, method = 'pmm', seed = 500)

long_HonorsData <- complete(new,3)
...
# anova(null_model_SC,lin_model_contempSC_CAMM,lin_model_SC_CAMM_controlled)
